...
SECRET_KEY = 'django-insecure-sle8=%8gmc9qwm8!n^bn5*p2*q_!iu&r1^-pyn(d@s=tmhxc3f'
...
INSTALLED_APPS = [
    ...
    'LittleLemonBooking.apps.LittlelemonbookingConfig'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['LittleLemonBooking/templates' ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
